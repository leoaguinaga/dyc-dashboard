  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 pt-2">
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          <label className="mb-1 block text-xs font-medium text-muted-foreground">Condición de pago <span className="font-normal text-muted-foreground/70">(opcional)</span></label>
          <Input
            value={condicionPago}
