    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-8 bg-white">
      ...
      <section className="space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          Define uno o más turnos (mañana, tarde, noche) para tomar asistencia. Los cambios se guardan de inmediato, no requieren &quot;Guardar cambios&quot;.
        </p>
        <TurnoConfigListEditor proyectoId={o.id} initial={o.turnoConfigs ?? []} />
      </section>
