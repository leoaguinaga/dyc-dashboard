          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/50">
                ...
                <th className="hidden px-4 py-2.5 text-left text-xs font-medium uppercase tracking-wide text-muted-foreground sm:table-cell">Fecha emisión</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {ordenes.map((oc) => (
                <tr key={oc.id} className="transition-colors duration-[120ms] hover:bg-muted/40">
                  ...
                  <td className="hidden px-4 py-3 font-mono text-xs text-muted-foreground tabular-nums sm:table-cell">
                    {oc.fechaEmision
