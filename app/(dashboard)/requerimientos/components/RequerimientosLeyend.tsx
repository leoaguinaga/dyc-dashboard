...
import { TIPO_LABEL, TIPO_CLASS, TIPO_COLOR } from './RequerimientosTableClient'
import type { TipoRequerimiento } from '@/types/api'

const TIPOS: TipoRequerimiento[] = ['civil', 'electrico', 'seguridad', 'administrativo']

interface RequerimientosLeyendProps {
  className?: string
  onScrollLeft?: () => void
  onScrollRight?: () => void
}

export default function RequerimientosLeyend({
  className,
  onScrollLeft,
  onScrollRight,
}: RequerimientosLeyendProps) {
  return (
